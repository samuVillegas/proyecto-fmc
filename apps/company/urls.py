...
urlpatterns = [
    ...
    path('search_key/<building_name>/<building_regulation>',views.search_key),
    ...
    path('set_building_type/<building_name>/<building_type>', views.set_building_type),
    path('edit_building/<building_name>', views.edit_building),
    path('edition_building/<building_name>', views.edition_building),
    path('site_parameterization_from_edit/<building_name>/<building_regulation>',views.site_parameterization_from_edit),
    path('delete_building', views.delete_building),
    path('view_building_information/<building_name>', views.view_building_information),
    ...
    path('search_flow/<building_name>/<building_type>/<building_regulation>', views.search_flow),
    path('site_inspection/<building_name>/<building_type>/<building_regulation>',views.site_inspection, name = "site_inspection"),
